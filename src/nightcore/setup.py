...
def create_bot(uow: UnitOfWork) -> Nightcore:
    ...
    cog_modules = [
        ...
        "src.nightcore.features.meta.commands.winter_holidays",
        "src.nightcore.features.meta.commands.roleselector",
        # faq commands
        ...
        "src.nightcore.features.clans.events.clan_manage_notify",
        # === economy
