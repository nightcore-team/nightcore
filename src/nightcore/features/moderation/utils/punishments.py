...
PUNISHMENTS_DESC_DICT: dict[str, dict[str, str]] = {
    "server": {
        ...
        "rrban": "получил блокировку на запрос ролей.",
        "unrrban": "был разблокирован на запрос ролей.",
    ...
    "dm": {
        ...
        "rrban": "получили блокировку на запрос ролей.",
        "unrrban": "были разблокированы на запрос ролей.",
