...
class ChannelType(Enum):
    ...
    NIGHTCORE_NOTIFICATIONS = "notifications_from_bot_webhook"
    MODERATION_NOTIFICATIONS = "notifications_for_moderation_webhook"

    LOGGING_ECONOMY = "economy_log_webhook"
    LOGGING_BANS = "bans_log_webhook"
    LOGGING_CLANS = "clans_log_webhook"
    LOGGING_MEMBERS = "members_log_webhook"
    LOGGING_MESSAGES = "messages_log_webhook"
    LOGGING_VOICES = "voices_log_webhook"
    LOGGING_MODERATION = "moderation_log_webhook"
    LOGGING_TICKETS = "tickets_log_webhook"
    LOGGING_ROLES = "roles_log_webhook"
    LOGGING_CHANNELS = "channels_log_webhook"
    LOGGING_REACTIONS = "reactions_log_webhook"
    LOGGING_PRIVATE_CHANNELS = "private_rooms_log_webhook"
